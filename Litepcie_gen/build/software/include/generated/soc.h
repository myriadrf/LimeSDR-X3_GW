...
static inline int pcie_dma1_reader_interrupt_read(void) {
	return 2;
}
static inline int pcie_dma1_writer_interrupt_read(void) {
	return 3;
}
static inline int pcie_dma2_reader_interrupt_read(void) {
	return 4;
}
static inline int pcie_dma2_writer_interrupt_read(void) {
	return 5;
}
