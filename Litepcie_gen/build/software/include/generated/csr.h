...
#define CSR_PCIE_DMA0_WRITER_TABLE_DMADESCRIPTORCNT_ADDR (CSR_BASE + 0x2818L)
#define CSR_PCIE_DMA0_WRITER_TABLE_DMADESCRIPTORCNT_SIZE 1
static inline uint32_t pcie_dma0_writer_table_dmaDescriptorCnt_read(void) {
	return csr_read_simple((CSR_BASE + 0x2818L));
}
#define CSR_PCIE_DMA0_WRITER_TABLE_DMADESCRIPTORCNT_DMACNT_OFFSET 0
#define CSR_PCIE_DMA0_WRITER_TABLE_DMADESCRIPTORCNT_DMACNT_SIZE 32
static inline uint32_t pcie_dma0_writer_table_dmadescriptorcnt_dmacnt_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 32)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t pcie_dma0_writer_table_dmadescriptorcnt_dmacnt_read(void) {
	uint32_t word = pcie_dma0_writer_table_dmadescriptorcnt_read();
	return pcie_dma0_writer_table_dmadescriptorcnt_dmacnt_extract(word);
}
#define CSR_PCIE_DMA0_WRITER_TABLE_LEVEL_ADDR (CSR_BASE + 0x281cL)
...
#define CSR_PCIE_DMA0_WRITER_TABLE_RESET_ADDR (CSR_BASE + 0x2820L)
...
#define CSR_PCIE_DMA0_READER_ENABLE_ADDR (CSR_BASE + 0x2824L)
...
#define CSR_PCIE_DMA0_READER_TABLE_WE_ADDR (CSR_BASE + 0x2830L)
...
#define CSR_PCIE_DMA0_READER_TABLE_LOOP_PROG_N_ADDR (CSR_BASE + 0x2834L)
...
#define CSR_PCIE_DMA0_READER_TABLE_LOOP_STATUS_ADDR (CSR_BASE + 0x2838L)
...
#define CSR_PCIE_DMA0_READER_TABLE_DMADESCRIPTORCNT_ADDR (CSR_BASE + 0x283cL)
#define CSR_PCIE_DMA0_READER_TABLE_DMADESCRIPTORCNT_SIZE 1
static inline uint32_t pcie_dma0_reader_table_dmaDescriptorCnt_read(void) {
	return csr_read_simple((CSR_BASE + 0x283cL));
}
#define CSR_PCIE_DMA0_READER_TABLE_DMADESCRIPTORCNT_DMACNT_OFFSET 0
#define CSR_PCIE_DMA0_READER_TABLE_DMADESCRIPTORCNT_DMACNT_SIZE 32
static inline uint32_t pcie_dma0_reader_table_dmadescriptorcnt_dmacnt_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 32)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t pcie_dma0_reader_table_dmadescriptorcnt_dmacnt_read(void) {
	uint32_t word = pcie_dma0_reader_table_dmadescriptorcnt_read();
	return pcie_dma0_reader_table_dmadescriptorcnt_dmacnt_extract(word);
}
#define CSR_PCIE_DMA0_READER_TABLE_LEVEL_ADDR (CSR_BASE + 0x2840L)
...
#define CSR_PCIE_DMA0_READER_TABLE_RESET_ADDR (CSR_BASE + 0x2844L)
...
#define CSR_PCIE_DMA0_BUFFERING_READER_FIFO_CONTROL_ADDR (CSR_BASE + 0x2848L)
...
#define CSR_PCIE_DMA0_BUFFERING_READER_FIFO_STATUS_ADDR (CSR_BASE + 0x284cL)
...
#define CSR_PCIE_DMA0_BUFFERING_WRITER_FIFO_CONTROL_ADDR (CSR_BASE + 0x2850L)
...
#define CSR_PCIE_DMA0_BUFFERING_WRITER_FIFO_STATUS_ADDR (CSR_BASE + 0x2854L)
...
static inline uint32_t pcie_dma1_writer_enable_read(void) {
	return csr_read_simple((CSR_BASE + 0x3000L));
}
static inline void pcie_dma1_writer_enable_write(uint32_t v) {
...
static inline uint64_t pcie_dma1_writer_table_value_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x3004L));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x3008L));
	return r;
}
static inline void pcie_dma1_writer_table_value_write(uint64_t v) {
	csr_write_simple(v >> 32, (CSR_BASE + 0x3004L));
...
static inline uint32_t pcie_dma1_writer_table_we_read(void) {
	return csr_read_simple((CSR_BASE + 0x300cL));
}
static inline void pcie_dma1_writer_table_we_write(uint32_t v) {
...
static inline uint32_t pcie_dma1_writer_table_we_address_msb_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 32)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t pcie_dma1_writer_table_we_address_msb_read(void) {
	uint32_t word = pcie_dma1_writer_table_we_read();
	return pcie_dma1_writer_table_we_address_msb_extract(word);
}
static inline uint32_t pcie_dma1_writer_table_we_address_msb_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 32)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void pcie_dma1_writer_table_we_address_msb_write(uint32_t plain_value) {
	uint32_t oldword = pcie_dma1_writer_table_we_read();
	uint32_t newword = pcie_dma1_writer_table_we_address_msb_replace(oldword, plain_value);
	pcie_dma1_writer_table_we_write(newword);
}
#define CSR_PCIE_DMA1_WRITER_TABLE_LOOP_PROG_N_ADDR (CSR_BASE + 0x3010L)
#define CSR_PCIE_DMA1_WRITER_TABLE_LOOP_PROG_N_SIZE 1
static inline uint32_t pcie_dma1_writer_table_loop_prog_n_read(void) {
	return csr_read_simple((CSR_BASE + 0x3010L));
}
static inline void pcie_dma1_writer_table_loop_prog_n_write(uint32_t v) {
...
static inline uint32_t pcie_dma1_writer_table_loop_status_read(void) {
...
static inline uint32_t pcie_dma1_writer_table_loop_status_index_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t pcie_dma1_writer_table_loop_status_index_read(void) {
	uint32_t word = pcie_dma1_writer_table_loop_status_read();
	return pcie_dma1_writer_table_loop_status_index_extract(word);
}
#define CSR_PCIE_DMA1_WRITER_TABLE_LOOP_STATUS_COUNT_OFFSET 16
#define CSR_PCIE_DMA1_WRITER_TABLE_LOOP_STATUS_COUNT_SIZE 16
static inline uint32_t pcie_dma1_writer_table_loop_status_count_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return ( (oldword >> 16) & mask );
}
static inline uint32_t pcie_dma1_writer_table_loop_status_count_read(void) {
	uint32_t word = pcie_dma1_writer_table_loop_status_read();
	return pcie_dma1_writer_table_loop_status_count_extract(word);
}
#define CSR_PCIE_DMA1_WRITER_TABLE_DMADESCRIPTORCNT_ADDR (CSR_BASE + 0x3018L)
#define CSR_PCIE_DMA1_WRITER_TABLE_DMADESCRIPTORCNT_SIZE 1
static inline uint32_t pcie_dma1_writer_table_dmaDescriptorCnt_read(void) {
	return csr_read_simple((CSR_BASE + 0x3018L));
}
#define CSR_PCIE_DMA1_WRITER_TABLE_DMADESCRIPTORCNT_DMACNT_OFFSET 0
#define CSR_PCIE_DMA1_WRITER_TABLE_DMADESCRIPTORCNT_DMACNT_SIZE 32
static inline uint32_t pcie_dma1_writer_table_dmadescriptorcnt_dmacnt_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 32)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t pcie_dma1_writer_table_dmadescriptorcnt_dmacnt_read(void) {
	uint32_t word = pcie_dma1_writer_table_dmadescriptorcnt_read();
	return pcie_dma1_writer_table_dmadescriptorcnt_dmacnt_extract(word);
}
#define CSR_PCIE_DMA1_WRITER_TABLE_LEVEL_ADDR (CSR_BASE + 0x301cL)
#define CSR_PCIE_DMA1_WRITER_TABLE_LEVEL_SIZE 1
static inline uint32_t pcie_dma1_writer_table_level_read(void) {
	return csr_read_simple((CSR_BASE + 0x301cL));
}
#define CSR_PCIE_DMA1_WRITER_TABLE_RESET_ADDR (CSR_BASE + 0x3020L)
#define CSR_PCIE_DMA1_WRITER_TABLE_RESET_SIZE 1
static inline uint32_t pcie_dma1_writer_table_reset_read(void) {
	return csr_read_simple((CSR_BASE + 0x3020L));
}
static inline void pcie_dma1_writer_table_reset_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x3020L));
}
#define CSR_PCIE_DMA1_READER_ENABLE_ADDR (CSR_BASE + 0x3024L)
#define CSR_PCIE_DMA1_READER_ENABLE_SIZE 1
static inline uint32_t pcie_dma1_reader_enable_read(void) {
	return csr_read_simple((CSR_BASE + 0x3024L));
}
static inline void pcie_dma1_reader_enable_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x3024L));
}
#define CSR_PCIE_DMA1_READER_TABLE_VALUE_ADDR (CSR_BASE + 0x3028L)
#define CSR_PCIE_DMA1_READER_TABLE_VALUE_SIZE 2
static inline uint64_t pcie_dma1_reader_table_value_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x3028L));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x302cL));
	return r;
}
static inline void pcie_dma1_reader_table_value_write(uint64_t v) {
	csr_write_simple(v >> 32, (CSR_BASE + 0x3028L));
...
#define CSR_PCIE_DMA1_READER_TABLE_WE_ADDR (CSR_BASE + 0x3030L)
#define CSR_PCIE_DMA1_READER_TABLE_WE_SIZE 1
static inline uint32_t pcie_dma1_reader_table_we_read(void) {
	return csr_read_simple((CSR_BASE + 0x3030L));
}
static inline void pcie_dma1_reader_table_we_write(uint32_t v) {
...
static inline uint32_t pcie_dma1_reader_table_we_address_msb_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 32)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t pcie_dma1_reader_table_we_address_msb_read(void) {
	uint32_t word = pcie_dma1_reader_table_we_read();
	return pcie_dma1_reader_table_we_address_msb_extract(word);
}
static inline uint32_t pcie_dma1_reader_table_we_address_msb_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 32)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void pcie_dma1_reader_table_we_address_msb_write(uint32_t plain_value) {
	uint32_t oldword = pcie_dma1_reader_table_we_read();
	uint32_t newword = pcie_dma1_reader_table_we_address_msb_replace(oldword, plain_value);
	pcie_dma1_reader_table_we_write(newword);
}
#define CSR_PCIE_DMA1_READER_TABLE_LOOP_PROG_N_ADDR (CSR_BASE + 0x3034L)
#define CSR_PCIE_DMA1_READER_TABLE_LOOP_PROG_N_SIZE 1
static inline uint32_t pcie_dma1_reader_table_loop_prog_n_read(void) {
	return csr_read_simple((CSR_BASE + 0x3034L));
}
static inline void pcie_dma1_reader_table_loop_prog_n_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x3034L));
}
#define CSR_PCIE_DMA1_READER_TABLE_LOOP_STATUS_ADDR (CSR_BASE + 0x3038L)
#define CSR_PCIE_DMA1_READER_TABLE_LOOP_STATUS_SIZE 1
static inline uint32_t pcie_dma1_reader_table_loop_status_read(void) {
...
static inline uint32_t pcie_dma1_reader_table_loop_status_index_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t pcie_dma1_reader_table_loop_status_index_read(void) {
	uint32_t word = pcie_dma1_reader_table_loop_status_read();
	return pcie_dma1_reader_table_loop_status_index_extract(word);
}
#define CSR_PCIE_DMA1_READER_TABLE_LOOP_STATUS_COUNT_OFFSET 16
#define CSR_PCIE_DMA1_READER_TABLE_LOOP_STATUS_COUNT_SIZE 16
static inline uint32_t pcie_dma1_reader_table_loop_status_count_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return ( (oldword >> 16) & mask );
}
static inline uint32_t pcie_dma1_reader_table_loop_status_count_read(void) {
	uint32_t word = pcie_dma1_reader_table_loop_status_read();
	return pcie_dma1_reader_table_loop_status_count_extract(word);
}
#define CSR_PCIE_DMA1_READER_TABLE_DMADESCRIPTORCNT_ADDR (CSR_BASE + 0x303cL)
#define CSR_PCIE_DMA1_READER_TABLE_DMADESCRIPTORCNT_SIZE 1
static inline uint32_t pcie_dma1_reader_table_dmaDescriptorCnt_read(void) {
	return csr_read_simple((CSR_BASE + 0x303cL));
}
#define CSR_PCIE_DMA1_READER_TABLE_DMADESCRIPTORCNT_DMACNT_OFFSET 0
#define CSR_PCIE_DMA1_READER_TABLE_DMADESCRIPTORCNT_DMACNT_SIZE 32
static inline uint32_t pcie_dma1_reader_table_dmadescriptorcnt_dmacnt_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 32)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t pcie_dma1_reader_table_dmadescriptorcnt_dmacnt_read(void) {
	uint32_t word = pcie_dma1_reader_table_dmadescriptorcnt_read();
	return pcie_dma1_reader_table_dmadescriptorcnt_dmacnt_extract(word);
}
#define CSR_PCIE_DMA1_READER_TABLE_LEVEL_ADDR (CSR_BASE + 0x3040L)
#define CSR_PCIE_DMA1_READER_TABLE_LEVEL_SIZE 1
static inline uint32_t pcie_dma1_reader_table_level_read(void) {
	return csr_read_simple((CSR_BASE + 0x3040L));
}
#define CSR_PCIE_DMA1_READER_TABLE_RESET_ADDR (CSR_BASE + 0x3044L)
#define CSR_PCIE_DMA1_READER_TABLE_RESET_SIZE 1
static inline uint32_t pcie_dma1_reader_table_reset_read(void) {
	return csr_read_simple((CSR_BASE + 0x3044L));
}
static inline void pcie_dma1_reader_table_reset_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x3044L));
}
#define CSR_PCIE_DMA1_BUFFERING_READER_FIFO_CONTROL_ADDR (CSR_BASE + 0x3048L)
#define CSR_PCIE_DMA1_BUFFERING_READER_FIFO_CONTROL_SIZE 1
static inline uint32_t pcie_dma1_buffering_reader_fifo_control_read(void) {
	return csr_read_simple((CSR_BASE + 0x3048L));
}
static inline void pcie_dma1_buffering_reader_fifo_control_write(uint32_t v) {
...
static inline uint32_t pcie_dma1_buffering_reader_fifo_control_depth_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 24)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t pcie_dma1_buffering_reader_fifo_control_depth_read(void) {
	uint32_t word = pcie_dma1_buffering_reader_fifo_control_read();
	return pcie_dma1_buffering_reader_fifo_control_depth_extract(word);
}
static inline uint32_t pcie_dma1_buffering_reader_fifo_control_depth_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 24)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void pcie_dma1_buffering_reader_fifo_control_depth_write(uint32_t plain_value) {
	uint32_t oldword = pcie_dma1_buffering_reader_fifo_control_read();
	uint32_t newword = pcie_dma1_buffering_reader_fifo_control_depth_replace(oldword, plain_value);
	pcie_dma1_buffering_reader_fifo_control_write(newword);
}
...
static inline uint32_t pcie_dma1_buffering_reader_fifo_control_scratch_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 4)-1);
	return ( (oldword >> 24) & mask );
}
static inline uint32_t pcie_dma1_buffering_reader_fifo_control_scratch_read(void) {
	uint32_t word = pcie_dma1_buffering_reader_fifo_control_read();
	return pcie_dma1_buffering_reader_fifo_control_scratch_extract(word);
}
static inline uint32_t pcie_dma1_buffering_reader_fifo_control_scratch_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 4)-1);
	return (oldword & (~(mask << 24))) | (mask & plain_value)<< 24 ;
}
static inline void pcie_dma1_buffering_reader_fifo_control_scratch_write(uint32_t plain_value) {
	uint32_t oldword = pcie_dma1_buffering_reader_fifo_control_read();
	uint32_t newword = pcie_dma1_buffering_reader_fifo_control_scratch_replace(oldword, plain_value);
	pcie_dma1_buffering_reader_fifo_control_write(newword);
}
...
static inline uint32_t pcie_dma1_buffering_reader_fifo_control_level_mode_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 1)-1);
	return ( (oldword >> 31) & mask );
}
static inline uint32_t pcie_dma1_buffering_reader_fifo_control_level_mode_read(void) {
	uint32_t word = pcie_dma1_buffering_reader_fifo_control_read();
	return pcie_dma1_buffering_reader_fifo_control_level_mode_extract(word);
}
static inline uint32_t pcie_dma1_buffering_reader_fifo_control_level_mode_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 1)-1);
	return (oldword & (~(mask << 31))) | (mask & plain_value)<< 31 ;
}
static inline void pcie_dma1_buffering_reader_fifo_control_level_mode_write(uint32_t plain_value) {
	uint32_t oldword = pcie_dma1_buffering_reader_fifo_control_read();
	uint32_t newword = pcie_dma1_buffering_reader_fifo_control_level_mode_replace(oldword, plain_value);
	pcie_dma1_buffering_reader_fifo_control_write(newword);
}
#define CSR_PCIE_DMA1_BUFFERING_READER_FIFO_STATUS_ADDR (CSR_BASE + 0x304cL)
#define CSR_PCIE_DMA1_BUFFERING_READER_FIFO_STATUS_SIZE 1
static inline uint32_t pcie_dma1_buffering_reader_fifo_status_read(void) {
...
static inline uint32_t pcie_dma1_buffering_reader_fifo_status_level_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 24)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t pcie_dma1_buffering_reader_fifo_status_level_read(void) {
	uint32_t word = pcie_dma1_buffering_reader_fifo_status_read();
	return pcie_dma1_buffering_reader_fifo_status_level_extract(word);
}
#define CSR_PCIE_DMA1_BUFFERING_WRITER_FIFO_CONTROL_ADDR (CSR_BASE + 0x3050L)
#define CSR_PCIE_DMA1_BUFFERING_WRITER_FIFO_CONTROL_SIZE 1
static inline uint32_t pcie_dma1_buffering_writer_fifo_control_read(void) {
	return csr_read_simple((CSR_BASE + 0x3050L));
}
static inline void pcie_dma1_buffering_writer_fifo_control_write(uint32_t v) {
...
static inline uint32_t pcie_dma1_buffering_writer_fifo_control_depth_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 24)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t pcie_dma1_buffering_writer_fifo_control_depth_read(void) {
	uint32_t word = pcie_dma1_buffering_writer_fifo_control_read();
	return pcie_dma1_buffering_writer_fifo_control_depth_extract(word);
}
static inline uint32_t pcie_dma1_buffering_writer_fifo_control_depth_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 24)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void pcie_dma1_buffering_writer_fifo_control_depth_write(uint32_t plain_value) {
	uint32_t oldword = pcie_dma1_buffering_writer_fifo_control_read();
	uint32_t newword = pcie_dma1_buffering_writer_fifo_control_depth_replace(oldword, plain_value);
	pcie_dma1_buffering_writer_fifo_control_write(newword);
}
...
static inline uint32_t pcie_dma1_buffering_writer_fifo_control_scratch_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 4)-1);
	return ( (oldword >> 24) & mask );
}
static inline uint32_t pcie_dma1_buffering_writer_fifo_control_scratch_read(void) {
	uint32_t word = pcie_dma1_buffering_writer_fifo_control_read();
	return pcie_dma1_buffering_writer_fifo_control_scratch_extract(word);
}
static inline uint32_t pcie_dma1_buffering_writer_fifo_control_scratch_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 4)-1);
	return (oldword & (~(mask << 24))) | (mask & plain_value)<< 24 ;
}
static inline void pcie_dma1_buffering_writer_fifo_control_scratch_write(uint32_t plain_value) {
	uint32_t oldword = pcie_dma1_buffering_writer_fifo_control_read();
	uint32_t newword = pcie_dma1_buffering_writer_fifo_control_scratch_replace(oldword, plain_value);
	pcie_dma1_buffering_writer_fifo_control_write(newword);
}
...
static inline uint32_t pcie_dma1_buffering_writer_fifo_control_level_mode_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 1)-1);
	return ( (oldword >> 31) & mask );
}
static inline uint32_t pcie_dma1_buffering_writer_fifo_control_level_mode_read(void) {
	uint32_t word = pcie_dma1_buffering_writer_fifo_control_read();
	return pcie_dma1_buffering_writer_fifo_control_level_mode_extract(word);
}
static inline uint32_t pcie_dma1_buffering_writer_fifo_control_level_mode_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 1)-1);
	return (oldword & (~(mask << 31))) | (mask & plain_value)<< 31 ;
}
static inline void pcie_dma1_buffering_writer_fifo_control_level_mode_write(uint32_t plain_value) {
	uint32_t oldword = pcie_dma1_buffering_writer_fifo_control_read();
	uint32_t newword = pcie_dma1_buffering_writer_fifo_control_level_mode_replace(oldword, plain_value);
	pcie_dma1_buffering_writer_fifo_control_write(newword);
}
#define CSR_PCIE_DMA1_BUFFERING_WRITER_FIFO_STATUS_ADDR (CSR_BASE + 0x3054L)
#define CSR_PCIE_DMA1_BUFFERING_WRITER_FIFO_STATUS_SIZE 1
static inline uint32_t pcie_dma1_buffering_writer_fifo_status_read(void) {
...
static inline uint32_t pcie_dma1_buffering_writer_fifo_status_level_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 24)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t pcie_dma1_buffering_writer_fifo_status_level_read(void) {
	uint32_t word = pcie_dma1_buffering_writer_fifo_status_read();
	return pcie_dma1_buffering_writer_fifo_status_level_extract(word);
}
...
static inline uint32_t pcie_dma2_writer_enable_read(void) {
	return csr_read_simple((CSR_BASE + 0x3800L));
}
static inline void pcie_dma2_writer_enable_write(uint32_t v) {
...
static inline uint64_t pcie_dma2_writer_table_value_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x3804L));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x3808L));
	return r;
}
static inline void pcie_dma2_writer_table_value_write(uint64_t v) {
	csr_write_simple(v >> 32, (CSR_BASE + 0x3804L));
...
static inline uint32_t pcie_dma2_writer_table_we_read(void) {
	return csr_read_simple((CSR_BASE + 0x380cL));
}
static inline void pcie_dma2_writer_table_we_write(uint32_t v) {
...
static inline uint32_t pcie_dma2_writer_table_we_address_msb_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 32)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t pcie_dma2_writer_table_we_address_msb_read(void) {
	uint32_t word = pcie_dma2_writer_table_we_read();
	return pcie_dma2_writer_table_we_address_msb_extract(word);
}
static inline uint32_t pcie_dma2_writer_table_we_address_msb_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 32)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void pcie_dma2_writer_table_we_address_msb_write(uint32_t plain_value) {
	uint32_t oldword = pcie_dma2_writer_table_we_read();
	uint32_t newword = pcie_dma2_writer_table_we_address_msb_replace(oldword, plain_value);
	pcie_dma2_writer_table_we_write(newword);
}
#define CSR_PCIE_DMA2_WRITER_TABLE_LOOP_PROG_N_ADDR (CSR_BASE + 0x3810L)
#define CSR_PCIE_DMA2_WRITER_TABLE_LOOP_PROG_N_SIZE 1
static inline uint32_t pcie_dma2_writer_table_loop_prog_n_read(void) {
	return csr_read_simple((CSR_BASE + 0x3810L));
}
static inline void pcie_dma2_writer_table_loop_prog_n_write(uint32_t v) {
...
static inline uint32_t pcie_dma2_writer_table_loop_status_read(void) {
...
static inline uint32_t pcie_dma2_writer_table_loop_status_index_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t pcie_dma2_writer_table_loop_status_index_read(void) {
	uint32_t word = pcie_dma2_writer_table_loop_status_read();
	return pcie_dma2_writer_table_loop_status_index_extract(word);
}
#define CSR_PCIE_DMA2_WRITER_TABLE_LOOP_STATUS_COUNT_OFFSET 16
#define CSR_PCIE_DMA2_WRITER_TABLE_LOOP_STATUS_COUNT_SIZE 16
static inline uint32_t pcie_dma2_writer_table_loop_status_count_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return ( (oldword >> 16) & mask );
}
static inline uint32_t pcie_dma2_writer_table_loop_status_count_read(void) {
	uint32_t word = pcie_dma2_writer_table_loop_status_read();
	return pcie_dma2_writer_table_loop_status_count_extract(word);
}
#define CSR_PCIE_DMA2_WRITER_TABLE_DMADESCRIPTORCNT_ADDR (CSR_BASE + 0x3818L)
#define CSR_PCIE_DMA2_WRITER_TABLE_DMADESCRIPTORCNT_SIZE 1
static inline uint32_t pcie_dma2_writer_table_dmaDescriptorCnt_read(void) {
	return csr_read_simple((CSR_BASE + 0x3818L));
}
#define CSR_PCIE_DMA2_WRITER_TABLE_DMADESCRIPTORCNT_DMACNT_OFFSET 0
#define CSR_PCIE_DMA2_WRITER_TABLE_DMADESCRIPTORCNT_DMACNT_SIZE 32
static inline uint32_t pcie_dma2_writer_table_dmadescriptorcnt_dmacnt_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 32)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t pcie_dma2_writer_table_dmadescriptorcnt_dmacnt_read(void) {
	uint32_t word = pcie_dma2_writer_table_dmadescriptorcnt_read();
	return pcie_dma2_writer_table_dmadescriptorcnt_dmacnt_extract(word);
}
#define CSR_PCIE_DMA2_WRITER_TABLE_LEVEL_ADDR (CSR_BASE + 0x381cL)
#define CSR_PCIE_DMA2_WRITER_TABLE_LEVEL_SIZE 1
static inline uint32_t pcie_dma2_writer_table_level_read(void) {
	return csr_read_simple((CSR_BASE + 0x381cL));
}
#define CSR_PCIE_DMA2_WRITER_TABLE_RESET_ADDR (CSR_BASE + 0x3820L)
#define CSR_PCIE_DMA2_WRITER_TABLE_RESET_SIZE 1
static inline uint32_t pcie_dma2_writer_table_reset_read(void) {
	return csr_read_simple((CSR_BASE + 0x3820L));
}
static inline void pcie_dma2_writer_table_reset_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x3820L));
}
#define CSR_PCIE_DMA2_READER_ENABLE_ADDR (CSR_BASE + 0x3824L)
#define CSR_PCIE_DMA2_READER_ENABLE_SIZE 1
static inline uint32_t pcie_dma2_reader_enable_read(void) {
	return csr_read_simple((CSR_BASE + 0x3824L));
}
static inline void pcie_dma2_reader_enable_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x3824L));
}
#define CSR_PCIE_DMA2_READER_TABLE_VALUE_ADDR (CSR_BASE + 0x3828L)
#define CSR_PCIE_DMA2_READER_TABLE_VALUE_SIZE 2
static inline uint64_t pcie_dma2_reader_table_value_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x3828L));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x382cL));
	return r;
}
static inline void pcie_dma2_reader_table_value_write(uint64_t v) {
	csr_write_simple(v >> 32, (CSR_BASE + 0x3828L));
...
#define CSR_PCIE_DMA2_READER_TABLE_WE_ADDR (CSR_BASE + 0x3830L)
#define CSR_PCIE_DMA2_READER_TABLE_WE_SIZE 1
static inline uint32_t pcie_dma2_reader_table_we_read(void) {
	return csr_read_simple((CSR_BASE + 0x3830L));
}
static inline void pcie_dma2_reader_table_we_write(uint32_t v) {
...
static inline uint32_t pcie_dma2_reader_table_we_address_msb_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 32)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t pcie_dma2_reader_table_we_address_msb_read(void) {
	uint32_t word = pcie_dma2_reader_table_we_read();
	return pcie_dma2_reader_table_we_address_msb_extract(word);
}
static inline uint32_t pcie_dma2_reader_table_we_address_msb_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 32)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void pcie_dma2_reader_table_we_address_msb_write(uint32_t plain_value) {
	uint32_t oldword = pcie_dma2_reader_table_we_read();
	uint32_t newword = pcie_dma2_reader_table_we_address_msb_replace(oldword, plain_value);
	pcie_dma2_reader_table_we_write(newword);
}
#define CSR_PCIE_DMA2_READER_TABLE_LOOP_PROG_N_ADDR (CSR_BASE + 0x3834L)
#define CSR_PCIE_DMA2_READER_TABLE_LOOP_PROG_N_SIZE 1
static inline uint32_t pcie_dma2_reader_table_loop_prog_n_read(void) {
	return csr_read_simple((CSR_BASE + 0x3834L));
}
static inline void pcie_dma2_reader_table_loop_prog_n_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x3834L));
}
#define CSR_PCIE_DMA2_READER_TABLE_LOOP_STATUS_ADDR (CSR_BASE + 0x3838L)
#define CSR_PCIE_DMA2_READER_TABLE_LOOP_STATUS_SIZE 1
static inline uint32_t pcie_dma2_reader_table_loop_status_read(void) {
...
static inline uint32_t pcie_dma2_reader_table_loop_status_index_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t pcie_dma2_reader_table_loop_status_index_read(void) {
	uint32_t word = pcie_dma2_reader_table_loop_status_read();
	return pcie_dma2_reader_table_loop_status_index_extract(word);
}
#define CSR_PCIE_DMA2_READER_TABLE_LOOP_STATUS_COUNT_OFFSET 16
#define CSR_PCIE_DMA2_READER_TABLE_LOOP_STATUS_COUNT_SIZE 16
static inline uint32_t pcie_dma2_reader_table_loop_status_count_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 16)-1);
	return ( (oldword >> 16) & mask );
}
static inline uint32_t pcie_dma2_reader_table_loop_status_count_read(void) {
	uint32_t word = pcie_dma2_reader_table_loop_status_read();
	return pcie_dma2_reader_table_loop_status_count_extract(word);
}
#define CSR_PCIE_DMA2_READER_TABLE_DMADESCRIPTORCNT_ADDR (CSR_BASE + 0x383cL)
#define CSR_PCIE_DMA2_READER_TABLE_DMADESCRIPTORCNT_SIZE 1
static inline uint32_t pcie_dma2_reader_table_dmaDescriptorCnt_read(void) {
	return csr_read_simple((CSR_BASE + 0x383cL));
}
#define CSR_PCIE_DMA2_READER_TABLE_DMADESCRIPTORCNT_DMACNT_OFFSET 0
#define CSR_PCIE_DMA2_READER_TABLE_DMADESCRIPTORCNT_DMACNT_SIZE 32
static inline uint32_t pcie_dma2_reader_table_dmadescriptorcnt_dmacnt_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 32)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t pcie_dma2_reader_table_dmadescriptorcnt_dmacnt_read(void) {
	uint32_t word = pcie_dma2_reader_table_dmadescriptorcnt_read();
	return pcie_dma2_reader_table_dmadescriptorcnt_dmacnt_extract(word);
}
#define CSR_PCIE_DMA2_READER_TABLE_LEVEL_ADDR (CSR_BASE + 0x3840L)
#define CSR_PCIE_DMA2_READER_TABLE_LEVEL_SIZE 1
static inline uint32_t pcie_dma2_reader_table_level_read(void) {
	return csr_read_simple((CSR_BASE + 0x3840L));
}
#define CSR_PCIE_DMA2_READER_TABLE_RESET_ADDR (CSR_BASE + 0x3844L)
#define CSR_PCIE_DMA2_READER_TABLE_RESET_SIZE 1
static inline uint32_t pcie_dma2_reader_table_reset_read(void) {
	return csr_read_simple((CSR_BASE + 0x3844L));
}
static inline void pcie_dma2_reader_table_reset_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x3844L));
}
#define CSR_PCIE_DMA2_BUFFERING_READER_FIFO_CONTROL_ADDR (CSR_BASE + 0x3848L)
#define CSR_PCIE_DMA2_BUFFERING_READER_FIFO_CONTROL_SIZE 1
static inline uint32_t pcie_dma2_buffering_reader_fifo_control_read(void) {
	return csr_read_simple((CSR_BASE + 0x3848L));
}
static inline void pcie_dma2_buffering_reader_fifo_control_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x3848L));
}
...
static inline uint32_t pcie_dma2_buffering_reader_fifo_control_depth_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 24)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t pcie_dma2_buffering_reader_fifo_control_depth_read(void) {
	uint32_t word = pcie_dma2_buffering_reader_fifo_control_read();
	return pcie_dma2_buffering_reader_fifo_control_depth_extract(word);
}
static inline uint32_t pcie_dma2_buffering_reader_fifo_control_depth_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 24)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void pcie_dma2_buffering_reader_fifo_control_depth_write(uint32_t plain_value) {
	uint32_t oldword = pcie_dma2_buffering_reader_fifo_control_read();
	uint32_t newword = pcie_dma2_buffering_reader_fifo_control_depth_replace(oldword, plain_value);
	pcie_dma2_buffering_reader_fifo_control_write(newword);
}
...
static inline uint32_t pcie_dma2_buffering_reader_fifo_control_scratch_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 4)-1);
	return ( (oldword >> 24) & mask );
}
static inline uint32_t pcie_dma2_buffering_reader_fifo_control_scratch_read(void) {
	uint32_t word = pcie_dma2_buffering_reader_fifo_control_read();
	return pcie_dma2_buffering_reader_fifo_control_scratch_extract(word);
}
static inline uint32_t pcie_dma2_buffering_reader_fifo_control_scratch_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 4)-1);
	return (oldword & (~(mask << 24))) | (mask & plain_value)<< 24 ;
}
static inline void pcie_dma2_buffering_reader_fifo_control_scratch_write(uint32_t plain_value) {
	uint32_t oldword = pcie_dma2_buffering_reader_fifo_control_read();
	uint32_t newword = pcie_dma2_buffering_reader_fifo_control_scratch_replace(oldword, plain_value);
	pcie_dma2_buffering_reader_fifo_control_write(newword);
}
...
static inline uint32_t pcie_dma2_buffering_reader_fifo_control_level_mode_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 1)-1);
	return ( (oldword >> 31) & mask );
}
static inline uint32_t pcie_dma2_buffering_reader_fifo_control_level_mode_read(void) {
	uint32_t word = pcie_dma2_buffering_reader_fifo_control_read();
	return pcie_dma2_buffering_reader_fifo_control_level_mode_extract(word);
}
static inline uint32_t pcie_dma2_buffering_reader_fifo_control_level_mode_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 1)-1);
	return (oldword & (~(mask << 31))) | (mask & plain_value)<< 31 ;
}
static inline void pcie_dma2_buffering_reader_fifo_control_level_mode_write(uint32_t plain_value) {
	uint32_t oldword = pcie_dma2_buffering_reader_fifo_control_read();
	uint32_t newword = pcie_dma2_buffering_reader_fifo_control_level_mode_replace(oldword, plain_value);
	pcie_dma2_buffering_reader_fifo_control_write(newword);
}
#define CSR_PCIE_DMA2_BUFFERING_READER_FIFO_STATUS_ADDR (CSR_BASE + 0x384cL)
#define CSR_PCIE_DMA2_BUFFERING_READER_FIFO_STATUS_SIZE 1
static inline uint32_t pcie_dma2_buffering_reader_fifo_status_read(void) {
...
static inline uint32_t pcie_dma2_buffering_reader_fifo_status_level_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 24)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t pcie_dma2_buffering_reader_fifo_status_level_read(void) {
	uint32_t word = pcie_dma2_buffering_reader_fifo_status_read();
	return pcie_dma2_buffering_reader_fifo_status_level_extract(word);
}
#define CSR_PCIE_DMA2_BUFFERING_WRITER_FIFO_CONTROL_ADDR (CSR_BASE + 0x3850L)
#define CSR_PCIE_DMA2_BUFFERING_WRITER_FIFO_CONTROL_SIZE 1
static inline uint32_t pcie_dma2_buffering_writer_fifo_control_read(void) {
	return csr_read_simple((CSR_BASE + 0x3850L));
}
static inline void pcie_dma2_buffering_writer_fifo_control_write(uint32_t v) {
...
static inline uint32_t pcie_dma2_buffering_writer_fifo_control_depth_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 24)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t pcie_dma2_buffering_writer_fifo_control_depth_read(void) {
	uint32_t word = pcie_dma2_buffering_writer_fifo_control_read();
	return pcie_dma2_buffering_writer_fifo_control_depth_extract(word);
}
static inline uint32_t pcie_dma2_buffering_writer_fifo_control_depth_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 24)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void pcie_dma2_buffering_writer_fifo_control_depth_write(uint32_t plain_value) {
	uint32_t oldword = pcie_dma2_buffering_writer_fifo_control_read();
	uint32_t newword = pcie_dma2_buffering_writer_fifo_control_depth_replace(oldword, plain_value);
	pcie_dma2_buffering_writer_fifo_control_write(newword);
}
...
static inline uint32_t pcie_dma2_buffering_writer_fifo_control_scratch_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 4)-1);
	return ( (oldword >> 24) & mask );
}
static inline uint32_t pcie_dma2_buffering_writer_fifo_control_scratch_read(void) {
	uint32_t word = pcie_dma2_buffering_writer_fifo_control_read();
	return pcie_dma2_buffering_writer_fifo_control_scratch_extract(word);
}
static inline uint32_t pcie_dma2_buffering_writer_fifo_control_scratch_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 4)-1);
	return (oldword & (~(mask << 24))) | (mask & plain_value)<< 24 ;
}
static inline void pcie_dma2_buffering_writer_fifo_control_scratch_write(uint32_t plain_value) {
	uint32_t oldword = pcie_dma2_buffering_writer_fifo_control_read();
	uint32_t newword = pcie_dma2_buffering_writer_fifo_control_scratch_replace(oldword, plain_value);
	pcie_dma2_buffering_writer_fifo_control_write(newword);
}
...
static inline uint32_t pcie_dma2_buffering_writer_fifo_control_level_mode_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 1)-1);
	return ( (oldword >> 31) & mask );
}
static inline uint32_t pcie_dma2_buffering_writer_fifo_control_level_mode_read(void) {
	uint32_t word = pcie_dma2_buffering_writer_fifo_control_read();
	return pcie_dma2_buffering_writer_fifo_control_level_mode_extract(word);
}
static inline uint32_t pcie_dma2_buffering_writer_fifo_control_level_mode_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 1)-1);
	return (oldword & (~(mask << 31))) | (mask & plain_value)<< 31 ;
}
static inline void pcie_dma2_buffering_writer_fifo_control_level_mode_write(uint32_t plain_value) {
	uint32_t oldword = pcie_dma2_buffering_writer_fifo_control_read();
	uint32_t newword = pcie_dma2_buffering_writer_fifo_control_level_mode_replace(oldword, plain_value);
	pcie_dma2_buffering_writer_fifo_control_write(newword);
}
#define CSR_PCIE_DMA2_BUFFERING_WRITER_FIFO_STATUS_ADDR (CSR_BASE + 0x3854L)
#define CSR_PCIE_DMA2_BUFFERING_WRITER_FIFO_STATUS_SIZE 1
static inline uint32_t pcie_dma2_buffering_writer_fifo_status_read(void) {
...
static inline uint32_t pcie_dma2_buffering_writer_fifo_status_level_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 24)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t pcie_dma2_buffering_writer_fifo_status_level_read(void) {
	uint32_t word = pcie_dma2_buffering_writer_fifo_status_read();
	return pcie_dma2_buffering_writer_fifo_status_level_extract(word);
}
