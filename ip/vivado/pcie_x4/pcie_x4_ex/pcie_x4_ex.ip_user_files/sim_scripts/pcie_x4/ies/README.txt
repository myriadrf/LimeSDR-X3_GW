...
#
# Generated by export_simulation on Fri Jul 26 13:46:30 +0300 2019
#
################################################################################
...
'-reset_run' switch to the './pcie_x4.sh' script.

./pcie_x4.sh -reset_run
...
./pcie_x4.sh -noclean_files

For more information on the script, please type './pcie_x4.sh -help'.
