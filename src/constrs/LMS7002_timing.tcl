...
#LMS1
set_input_delay -clock [get_clocks LMS1_MCLK2_VIRT] -max 2.350 [get_ports {{LMS1_DIQ2_D[*]} LMS1_ENABLE_IQSEL2}]

set_input_delay -clock [get_clocks LMS1_MCLK2_VIRT] -min 1.200 [get_ports {{LMS1_DIQ2_D[*]} LMS1_ENABLE_IQSEL2}]

set_input_delay -clock [get_clocks LMS1_MCLK2_VIRT] -clock_fall -max -add_delay 2.350 [get_ports {{LMS1_DIQ2_D[*]} LMS1_ENABLE_IQSEL2}]

set_input_delay -clock [get_clocks LMS1_MCLK2_VIRT] -clock_fall -min -add_delay 1.200 [get_ports {{LMS1_DIQ2_D[*]} LMS1_ENABLE_IQSEL2}]
