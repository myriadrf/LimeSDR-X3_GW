...
set_property IOSTANDARD LVCMOS33 [get_ports {ADF_MUXOUT PD_LMS*}]
set_property IOSTANDARD LVCMOS25 [get_ports {CDCM*_RESET_N CDCM*_STATUS0 CDCM*_STATUS1 CDCM*_SYNCN LMS2_RX*} ]
set_property IOSTANDARD LVCMOS25 [get_ports {HW_VER[*] BOM_VER[*] EXT_GND XO_TUNE_FPGA LM75_OS FAN_CTRL}]
