//------------------------------------------------------------
// Generated by Migen & LiteX / -------- / 2019-10-14 16:35:03
//------------------------------------------------------------
...
assign litepciecore_csrbank1_reader_flush_nr0_re = ((litepciecore_csrbank1_sel & litepciecore_interface1_bank_bus_we) & (litepciecore_interface1_bank_bus_adr[4:0] == 5'd18));
assign litepciecore_csrbank1_reader_flush_nbytes0_r = litepciecore_interface1_bank_bus_dat_w[15:0];
assign litepciecore_csrbank1_reader_flush_nbytes0_re = ((litepciecore_csrbank1_sel & litepciecore_interface1_bank_bus_we) & (litepciecore_interface1_bank_bus_adr[4:0] == 5'd19));
...
assign litepciecore_csrbank2_reader_flush_nr0_re = ((litepciecore_csrbank2_sel & litepciecore_interface2_bank_bus_we) & (litepciecore_interface2_bank_bus_adr[4:0] == 5'd18));
assign litepciecore_csrbank2_reader_flush_nbytes0_r = litepciecore_interface2_bank_bus_dat_w[15:0];
assign litepciecore_csrbank2_reader_flush_nbytes0_re = ((litepciecore_csrbank2_sel & litepciecore_interface2_bank_bus_we) & (litepciecore_interface2_bank_bus_adr[4:0] == 5'd19));
...
assign litepciecore_csrbank3_reader_flush_nr0_re = ((litepciecore_csrbank3_sel & litepciecore_interface3_bank_bus_we) & (litepciecore_interface3_bank_bus_adr[4:0] == 5'd18));
assign litepciecore_csrbank3_reader_flush_nbytes0_r = litepciecore_interface3_bank_bus_dat_w[15:0];
assign litepciecore_csrbank3_reader_flush_nbytes0_re = ((litepciecore_csrbank3_sel & litepciecore_interface3_bank_bus_we) & (litepciecore_interface3_bank_bus_adr[4:0] == 5'd19));
