//------------------------------------------------------------
// Generated by Migen & LiteX / -------- / 2019-10-31 10:42:25
// Without short packet support(Kernel is with allow_request and didn't change)
//------------------------------------------------------------
...
assign litepciedma0_syncfifo0_syncfifo0_writable = (litepciedma0_syncfifo0_level0 != 10'd640);
...
assign litepciedma0_syncfifo1_syncfifo1_writable = (litepciedma0_syncfifo1_level0 != 10'd640);
...
assign litepciedma1_syncfifo2_syncfifo2_writable = (litepciedma1_syncfifo2_level0 != 10'd640);
...
assign litepciedma1_syncfifo3_syncfifo3_writable = (litepciedma1_syncfifo3_level0 != 10'd640);
...
assign litepciedma2_syncfifo4_syncfifo4_writable = (litepciedma2_syncfifo4_level0 != 10'd640);
...
assign litepciedma2_syncfifo5_syncfifo5_writable = (litepciedma2_syncfifo5_level0 != 10'd640);
...
always @(posedge sys_clk) begin
	...
	if (((litepciedma0_syncfifo0_syncfifo0_we & litepciedma0_syncfifo0_syncfifo0_writable) & (~litepciedma0_syncfifo0_replace))) begin
		if ((litepciedma0_syncfifo0_produce == 10'd639)) begin
	...
	if (litepciedma0_syncfifo0_do_read) begin
		if ((litepciedma0_syncfifo0_consume == 10'd639)) begin
	...
	if (((litepciedma0_syncfifo1_syncfifo1_we & litepciedma0_syncfifo1_syncfifo1_writable) & (~litepciedma0_syncfifo1_replace))) begin
		if ((litepciedma0_syncfifo1_produce == 10'd639)) begin
	...
	if (litepciedma0_syncfifo1_do_read) begin
		if ((litepciedma0_syncfifo1_consume == 10'd639)) begin
	...
	if (((litepciedma1_syncfifo2_syncfifo2_we & litepciedma1_syncfifo2_syncfifo2_writable) & (~litepciedma1_syncfifo2_replace))) begin
		if ((litepciedma1_syncfifo2_produce == 10'd639)) begin
	...
	if (litepciedma1_syncfifo2_do_read) begin
		if ((litepciedma1_syncfifo2_consume == 10'd639)) begin
	...
	if (((litepciedma1_syncfifo3_syncfifo3_we & litepciedma1_syncfifo3_syncfifo3_writable) & (~litepciedma1_syncfifo3_replace))) begin
		if ((litepciedma1_syncfifo3_produce == 10'd639)) begin
	...
	if (litepciedma1_syncfifo3_do_read) begin
		if ((litepciedma1_syncfifo3_consume == 10'd639)) begin
	...
	if (((litepciedma2_syncfifo4_syncfifo4_we & litepciedma2_syncfifo4_syncfifo4_writable) & (~litepciedma2_syncfifo4_replace))) begin
		if ((litepciedma2_syncfifo4_produce == 10'd639)) begin
	...
	if (litepciedma2_syncfifo4_do_read) begin
		if ((litepciedma2_syncfifo4_consume == 10'd639)) begin
	...
	if (((litepciedma2_syncfifo5_syncfifo5_we & litepciedma2_syncfifo5_syncfifo5_writable) & (~litepciedma2_syncfifo5_replace))) begin
		if ((litepciedma2_syncfifo5_produce == 10'd639)) begin
	...
	if (litepciedma2_syncfifo5_do_read) begin
		if ((litepciedma2_syncfifo5_consume == 10'd639)) begin
