//------------------------------------------------------------
// Generated by Migen & LiteX / -------- / 2019-11-25 11:37:14
//------------------------------------------------------------
...
(* DONT_TOUCH="TRUE" *)reg [15:0] litepciedma0_reader_current_packet_status = 16'd0;
...
(* DONT_TOUCH="TRUE" *)reg [15:0] litepciedma0_reader_current_packet_test_status = 16'd0;
...
(* DONT_TOUCH="TRUE" *)reg [15:0] litepciedma1_reader_current_packet_status = 16'd0;
...
(* DONT_TOUCH="TRUE" *)reg [15:0] litepciedma1_reader_current_packet_test_status = 16'd0;
...
(* DONT_TOUCH="TRUE" *)reg [15:0] litepciedma2_reader_current_packet_status = 16'd0;
...
(* DONT_TOUCH="TRUE" *)reg [15:0] litepciedma2_reader_current_packet_test_status = 16'd0;
...
wire litepciecore_csrbank1_reader_current_packet_test_re;
wire [15:0] litepciecore_csrbank1_reader_current_packet_test_r;
wire [15:0] litepciecore_csrbank1_reader_current_packet_test_w;
...
wire litepciecore_csrbank2_reader_current_packet_test_re;
wire [15:0] litepciecore_csrbank2_reader_current_packet_test_r;
wire [15:0] litepciecore_csrbank2_reader_current_packet_test_w;
...
wire litepciecore_csrbank3_reader_current_packet_test_re;
wire [15:0] litepciecore_csrbank3_reader_current_packet_test_r;
wire [15:0] litepciecore_csrbank3_reader_current_packet_test_w;
...
assign litepciecore_csrbank1_reader_current_packet_test_r = litepciecore_interface1_bank_bus_dat_w[15:0];
assign litepciecore_csrbank1_reader_current_packet_test_re = ((litepciecore_csrbank1_sel & litepciecore_interface1_bank_bus_we) & (litepciecore_interface1_bank_bus_adr[4:0] == 5'd22));
assign litepciecore_csrbank1_buffering_reader_fifo_level_r = litepciecore_interface1_bank_bus_dat_w[13:0];
assign litepciecore_csrbank1_buffering_reader_fifo_level_re = ((litepciecore_csrbank1_sel & litepciecore_interface1_bank_bus_we) & (litepciecore_interface1_bank_bus_adr[4:0] == 5'd23));
assign litepciecore_csrbank1_buffering_writer_fifo_level_r = litepciecore_interface1_bank_bus_dat_w[13:0];
assign litepciecore_csrbank1_buffering_writer_fifo_level_re = ((litepciecore_csrbank1_sel & litepciecore_interface1_bank_bus_we) & (litepciecore_interface1_bank_bus_adr[4:0] == 5'd24));
...
assign litepciecore_csrbank1_reader_current_packet_w = litepciedma0_reader_current_packet_status[15:0];
...
assign litepciecore_csrbank1_reader_current_packet_test_w = litepciedma0_reader_current_packet_test_status[15:0];
...
assign litepciecore_csrbank2_reader_current_packet_test_r = litepciecore_interface2_bank_bus_dat_w[15:0];
assign litepciecore_csrbank2_reader_current_packet_test_re = ((litepciecore_csrbank2_sel & litepciecore_interface2_bank_bus_we) & (litepciecore_interface2_bank_bus_adr[4:0] == 5'd22));
assign litepciecore_csrbank2_buffering_reader_fifo_level_r = litepciecore_interface2_bank_bus_dat_w[13:0];
assign litepciecore_csrbank2_buffering_reader_fifo_level_re = ((litepciecore_csrbank2_sel & litepciecore_interface2_bank_bus_we) & (litepciecore_interface2_bank_bus_adr[4:0] == 5'd23));
assign litepciecore_csrbank2_buffering_writer_fifo_level_r = litepciecore_interface2_bank_bus_dat_w[13:0];
assign litepciecore_csrbank2_buffering_writer_fifo_level_re = ((litepciecore_csrbank2_sel & litepciecore_interface2_bank_bus_we) & (litepciecore_interface2_bank_bus_adr[4:0] == 5'd24));
...
assign litepciecore_csrbank2_reader_current_packet_w = litepciedma1_reader_current_packet_status[15:0];
...
assign litepciecore_csrbank2_reader_current_packet_test_w = litepciedma1_reader_current_packet_test_status[15:0];
...
assign litepciecore_csrbank3_reader_current_packet_test_r = litepciecore_interface3_bank_bus_dat_w[15:0];
assign litepciecore_csrbank3_reader_current_packet_test_re = ((litepciecore_csrbank3_sel & litepciecore_interface3_bank_bus_we) & (litepciecore_interface3_bank_bus_adr[4:0] == 5'd22));
assign litepciecore_csrbank3_buffering_reader_fifo_level_r = litepciecore_interface3_bank_bus_dat_w[13:0];
assign litepciecore_csrbank3_buffering_reader_fifo_level_re = ((litepciecore_csrbank3_sel & litepciecore_interface3_bank_bus_we) & (litepciecore_interface3_bank_bus_adr[4:0] == 5'd23));
assign litepciecore_csrbank3_buffering_writer_fifo_level_r = litepciecore_interface3_bank_bus_dat_w[13:0];
assign litepciecore_csrbank3_buffering_writer_fifo_level_re = ((litepciecore_csrbank3_sel & litepciecore_interface3_bank_bus_we) & (litepciecore_interface3_bank_bus_adr[4:0] == 5'd24));
...
assign litepciecore_csrbank3_reader_current_packet_w = litepciedma2_reader_current_packet_status[15:0];
...
assign litepciecore_csrbank3_reader_current_packet_test_w = litepciedma2_reader_current_packet_test_status[15:0];
...
always @(posedge sys_clk) begin
	...
	if ((((litepciedma0_writer_bufferizeendpoints0_source_valid & litepciedma0_writer_bufferizeendpoints0_source_ready) & litepciedma0_writer_bufferizeendpoints0_source_last) & (~litepciedma0_writer_bufferizeendpoints0_source_payload_control[0]))) begin
		litepciedma0_writer_status <= (litepciedma0_writer_status + 1'd1);
	end else begin
		if ((~litepciedma0_writer_enable_storage)) begin
			litepciedma0_writer_status <= 1'd0;
		end
	end
	...
	litepciedma0_reader_current_packet_status <= litepciedma0_reader_req_pck_cnt;
	...
	if ((((litepciedma0_reader_bufferizeendpoints0_source_valid & litepciedma0_reader_bufferizeendpoints0_source_ready) & litepciedma0_reader_bufferizeendpoints0_source_last) & (~litepciedma0_reader_bufferizeendpoints0_source_payload_control[0]))) begin
		litepciedma0_reader_current_packet_test_status <= (litepciedma0_reader_current_packet_test_status + 1'd1);
	end else begin
		if ((~litepciedma0_reader_enable_storage)) begin
			litepciedma0_reader_current_packet_test_status <= 1'd0;
		end
	end
	...
	if ((((litepciedma1_writer_bufferizeendpoints1_source_valid & litepciedma1_writer_bufferizeendpoints1_source_ready) & litepciedma1_writer_bufferizeendpoints1_source_last) & (~litepciedma1_writer_bufferizeendpoints1_source_payload_control[0]))) begin
		litepciedma1_writer_status <= (litepciedma1_writer_status + 1'd1);
	end else begin
		if ((~litepciedma1_writer_enable_storage)) begin
			litepciedma1_writer_status <= 1'd0;
		end
	end
	...
	litepciedma1_reader_current_packet_status <= litepciedma1_reader_req_pck_cnt;
	...
	if ((((litepciedma1_reader_bufferizeendpoints1_source_valid & litepciedma1_reader_bufferizeendpoints1_source_ready) & litepciedma1_reader_bufferizeendpoints1_source_last) & (~litepciedma1_reader_bufferizeendpoints1_source_payload_control[0]))) begin
		litepciedma1_reader_current_packet_test_status <= (litepciedma1_reader_current_packet_test_status + 1'd1);
	end else begin
		if ((~litepciedma1_reader_enable_storage)) begin
			litepciedma1_reader_current_packet_test_status <= 1'd0;
		end
	end
	...
	if ((((litepciedma2_writer_bufferizeendpoints2_source_valid & litepciedma2_writer_bufferizeendpoints2_source_ready) & litepciedma2_writer_bufferizeendpoints2_source_last) & (~litepciedma2_writer_bufferizeendpoints2_source_payload_control[0]))) begin
		litepciedma2_writer_status <= (litepciedma2_writer_status + 1'd1);
	end else begin
		if ((~litepciedma2_writer_enable_storage)) begin
			litepciedma2_writer_status <= 1'd0;
		end
	end
	...
	litepciedma2_reader_current_packet_status <= litepciedma2_reader_req_pck_cnt;
	...
	if ((((litepciedma2_reader_bufferizeendpoints2_source_valid & litepciedma2_reader_bufferizeendpoints2_source_ready) & litepciedma2_reader_bufferizeendpoints2_source_last) & (~litepciedma2_reader_bufferizeendpoints2_source_payload_control[0]))) begin
		litepciedma2_reader_current_packet_test_status <= (litepciedma2_reader_current_packet_test_status + 1'd1);
	end else begin
		if ((~litepciedma2_reader_enable_storage)) begin
			litepciedma2_reader_current_packet_test_status <= 1'd0;
		end
	end
	...
	if (litepciecore_csrbank1_sel) begin
		case (litepciecore_interface1_bank_bus_adr[4:0])
			...
			5'd22: begin
				litepciecore_interface1_bank_bus_dat_r <= litepciecore_csrbank1_reader_current_packet_test_w;
			end
			5'd23: begin
	...
	if (litepciecore_csrbank2_sel) begin
		case (litepciecore_interface2_bank_bus_adr[4:0])
			...
			5'd22: begin
				litepciecore_interface2_bank_bus_dat_r <= litepciecore_csrbank2_reader_current_packet_test_w;
			end
			5'd23: begin
	...
	if (litepciecore_csrbank3_sel) begin
		case (litepciecore_interface3_bank_bus_adr[4:0])
			...
			5'd22: begin
				litepciecore_interface3_bank_bus_dat_r <= litepciecore_csrbank3_reader_current_packet_test_w;
			end
			5'd23: begin
	...
	if (sys_rst) begin
		...
		litepciedma0_reader_current_packet_status <= 16'd0;
		...
		litepciedma0_reader_bad_fifo_write <= 1'd0;
		litepciedma0_reader_current_packet_test_status <= 16'd0;
		litepciedma0_syncfifo0_readable <= 1'd0;
		litepciedma0_syncfifo0_level0 <= 10'd0;
		litepciedma0_syncfifo0_produce <= 10'd0;
		litepciedma0_syncfifo0_consume <= 10'd0;
		...
		litepciedma1_reader_current_packet_status <= 16'd0;
		...
		litepciedma1_reader_bad_fifo_write <= 1'd0;
		litepciedma1_reader_current_packet_test_status <= 16'd0;
		litepciedma1_syncfifo2_readable <= 1'd0;
		litepciedma1_syncfifo2_level0 <= 10'd0;
		litepciedma1_syncfifo2_produce <= 10'd0;
		litepciedma1_syncfifo2_consume <= 10'd0;
		...
		litepciedma2_reader_current_packet_status <= 16'd0;
		...
		litepciedma2_reader_bad_fifo_write <= 1'd0;
		litepciedma2_reader_current_packet_test_status <= 16'd0;
		litepciedma2_syncfifo4_readable <= 1'd0;
		litepciedma2_syncfifo4_level0 <= 10'd0;
		litepciedma2_syncfifo4_produce <= 10'd0;
		litepciedma2_syncfifo4_consume <= 10'd0;
