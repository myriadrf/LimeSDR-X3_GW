//------------------------------------------------------------
// Generated by Migen & LiteX / -------- / 2019-11-07 10:30:36
// 12kb buffer, old pcie_phy, new commits.
//------------------------------------------------------------
...
assign litepciecore_csrbank1_buffering_reader_fifo_level_re = ((litepciecore_csrbank1_sel & litepciecore_interface1_bank_bus_we) & (litepciecore_interface1_bank_bus_adr[4:0] == 5'd21));
assign litepciecore_csrbank1_buffering_writer_fifo_level_r = litepciecore_interface1_bank_bus_dat_w[13:0];
assign litepciecore_csrbank1_buffering_writer_fifo_level_re = ((litepciecore_csrbank1_sel & litepciecore_interface1_bank_bus_we) & (litepciecore_interface1_bank_bus_adr[4:0] == 5'd22));
...
assign litepciecore_csrbank2_buffering_reader_fifo_level_re = ((litepciecore_csrbank2_sel & litepciecore_interface2_bank_bus_we) & (litepciecore_interface2_bank_bus_adr[4:0] == 5'd21));
assign litepciecore_csrbank2_buffering_writer_fifo_level_r = litepciecore_interface2_bank_bus_dat_w[13:0];
assign litepciecore_csrbank2_buffering_writer_fifo_level_re = ((litepciecore_csrbank2_sel & litepciecore_interface2_bank_bus_we) & (litepciecore_interface2_bank_bus_adr[4:0] == 5'd22));
...
assign litepciecore_csrbank3_buffering_reader_fifo_level_re = ((litepciecore_csrbank3_sel & litepciecore_interface3_bank_bus_we) & (litepciecore_interface3_bank_bus_adr[4:0] == 5'd21));
assign litepciecore_csrbank3_buffering_writer_fifo_level_r = litepciecore_interface3_bank_bus_dat_w[13:0];
assign litepciecore_csrbank3_buffering_writer_fifo_level_re = ((litepciecore_csrbank3_sel & litepciecore_interface3_bank_bus_we) & (litepciecore_interface3_bank_bus_adr[4:0] == 5'd22));
