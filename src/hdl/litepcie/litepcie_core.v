...
wire          from2853850009120_clk;
wire          from2853850009120_rst;
wire          to2853850009120_clk;
wire          to2853850009120_rst;
...
wire          from2853851326608_clk;
wire          from2853851326608_rst;
wire          to2853851326608_clk;
wire          to2853851326608_rst;
...
wire          from2853850545216_clk;
wire          from2853850545216_rst;
wire          to2853850545216_clk;
wire          to2853850545216_rst;
...
reg           litepciedma2_writer_table_loop_first = 1'd0;
...
wire          litepciedma2_writer_splitter_terminate;
...
reg    [23:0] litepciedma2_writer_req_count_bufferizeendpoints2_fsm2_next_value = 24'd0;
reg           litepciedma2_writer_req_count_bufferizeendpoints2_fsm2_next_value_ce = 1'd0;
...
assign from2853850009120_clk = sys_clk;
assign to2853850009120_clk = pcie_clk;
...
assign from2853851326608_clk = pcie_clk;
assign to2853851326608_clk = sys_clk;
...
assign from2853850545216_clk = sys_clk;
assign to2853850545216_clk = pcie_clk;
...
assign litepciedma0_writer_splitter_terminate = (litepciedma0_writer_data_fifo_source_last & (~litepciedma0_writer_splitter_source_source_payload_last_disable));
always @(*) begin
    ...
    case (litepciecore_bufferizeendpoints0_state0)
        1'd1: begin
            ...
            if ((litepciedma0_writer_splitter_desc_length > s7pciephy_max_payload_size)) begin
                litepciedma0_writer_splitter_source_last <= litepciedma0_writer_splitter_terminate;
    ...
    case (litepciecore_bufferizeendpoints0_state1)
        1'd1: begin
            ...
            if ((litepciedma0_reader_splitter_desc_length > s7pciephy_max_request_size)) begin
                litepciedma0_reader_splitter_source_last <= litepciedma0_reader_splitter_terminate;
...
assign litepciedma1_writer_splitter_terminate = (litepciedma1_writer_data_fifo_source_last & (~litepciedma1_writer_splitter_source_source_payload_last_disable));
always @(*) begin
    ...
    case (litepciecore_bufferizeendpoints1_state0)
        1'd1: begin
            ...
            if ((litepciedma1_writer_splitter_desc_length > s7pciephy_max_payload_size)) begin
                litepciedma1_writer_splitter_source_last <= litepciedma1_writer_splitter_terminate;
    ...
    case (litepciecore_bufferizeendpoints1_state1)
        1'd1: begin
            ...
            if ((litepciedma1_reader_splitter_desc_length > s7pciephy_max_request_size)) begin
                litepciedma1_reader_splitter_source_last <= litepciedma1_reader_splitter_terminate;
...
assign litepciedma2_writer_splitter_terminate = (litepciedma2_writer_data_fifo_source_last & (~litepciedma2_writer_splitter_source_source_payload_last_disable));
always @(*) begin
    ...
    case (litepciecore_bufferizeendpoints2_state0)
        1'd1: begin
            ...
            if ((litepciedma2_writer_splitter_desc_length > s7pciephy_max_payload_size)) begin
                litepciedma2_writer_splitter_source_last <= litepciedma2_writer_splitter_terminate;
...
always @(*) begin
    ...
    litepciedma2_writer_req_count_bufferizeendpoints2_fsm2_next_value <= 24'd0;
    litepciedma2_writer_req_count_bufferizeendpoints2_fsm2_next_value_ce <= 1'd0;
    ...
    case (litepciecore_fsm2_state0)
        1'd1: begin
            ...
            if (litepciedma2_litepciemasterinternalport4_sink_ready) begin
                litepciedma2_writer_req_count_bufferizeendpoints2_fsm2_next_value <= (litepciedma2_writer_req_count + 1'd1);
                litepciedma2_writer_req_count_bufferizeendpoints2_fsm2_next_value_ce <= 1'd1;
                litepciedma2_writer_data_fifo_source_ready <= (~litepciedma2_writer_splitter_terminate);
                if (litepciedma2_litepciemasterinternalport4_sink_last) begin
                    litepciedma2_writer_splitter_source_source_ready <= 1'd1;
                    litepciedma2_writer_data_fifo_source_ready <= 1'd1;
                    litepciecore_fsm2_next_state0 <= 1'd0;
                end
            end
        end
        default: begin
            ...
            litepciedma2_writer_req_count_bufferizeendpoints2_fsm2_next_value <= 1'd0;
            litepciedma2_writer_req_count_bufferizeendpoints2_fsm2_next_value_ce <= 1'd1;
    ...
    case (litepciecore_bufferizeendpoints2_state1)
        1'd1: begin
            ...
            if ((litepciedma2_reader_splitter_desc_length > s7pciephy_max_request_size)) begin
                litepciedma2_reader_splitter_source_last <= litepciedma2_reader_splitter_terminate;
...
always @(posedge from2853850009120_clk) begin
    ...
    if (from2853850009120_rst) begin
...
always @(posedge from2853850545216_clk) begin
    ...
    if (from2853850545216_rst) begin
...
always @(posedge from2853851326608_clk) begin
    ...
    if (from2853851326608_rst) begin
...
always @(posedge sys_clk) begin
    ...
    if (litepciedma0_writer_table_table_reset) begin
        ...
        if ((litepciedma0_writer_table_table_source_valid & litepciedma0_writer_table_table_source_ready)) begin
            if (((litepciedma0_writer_table_loop_prog_n_storage == 1'd1) & litepciedma0_writer_table_table_source_first)) begin
                litepciedma0_writer_table_index <= 1'd0;
    ...
    if (litepciedma0_reader_table_table_reset) begin
        ...
        if ((litepciedma0_reader_table_table_source_valid & litepciedma0_reader_table_table_source_ready)) begin
            if (((litepciedma0_reader_table_loop_prog_n_storage == 1'd1) & litepciedma0_reader_table_table_source_first)) begin
                litepciedma0_reader_table_index <= 1'd0;
    ...
    if (litepciedma1_writer_table_table_reset) begin
        ...
        if ((litepciedma1_writer_table_table_source_valid & litepciedma1_writer_table_table_source_ready)) begin
            if (((litepciedma1_writer_table_loop_prog_n_storage == 1'd1) & litepciedma1_writer_table_table_source_first)) begin
                litepciedma1_writer_table_index <= 1'd0;
    ...
    if (litepciedma1_reader_table_table_reset) begin
        ...
        if ((litepciedma1_reader_table_table_source_valid & litepciedma1_reader_table_table_source_ready)) begin
            if (((litepciedma1_reader_table_loop_prog_n_storage == 1'd1) & litepciedma1_reader_table_table_source_first)) begin
                litepciedma1_reader_table_index <= 1'd0;
    ...
    if (litepciedma2_writer_table_table_reset) begin
        litepciedma2_writer_table_loop_first <= 1'd1;
        litepciedma2_writer_table_index <= 1'd0;
        litepciedma2_writer_table_count <= 1'd0;
    end else begin
        if ((litepciedma2_writer_table_table_source_valid & litepciedma2_writer_table_table_source_ready)) begin
            if (((litepciedma2_writer_table_loop_prog_n_storage == 1'd1) & litepciedma2_writer_table_table_source_first)) begin
                litepciedma2_writer_table_index <= 1'd0;
                litepciedma2_writer_table_loop_first <= 1'd0;
                litepciedma2_writer_table_count <= (litepciedma2_writer_table_count + {(~litepciedma2_writer_table_loop_first)});
            end else begin
                litepciedma2_writer_table_index <= (litepciedma2_writer_table_index + 1'd1);
                if ((litepciedma2_writer_table_index == 16'd65535)) begin
    ...
    if (litepciedma2_writer_req_count_bufferizeendpoints2_fsm2_next_value_ce) begin
        litepciedma2_writer_req_count <= litepciedma2_writer_req_count_bufferizeendpoints2_fsm2_next_value;
    end
    ...
    if (litepciedma2_reader_table_table_reset) begin
        ...
        if ((litepciedma2_reader_table_table_source_valid & litepciedma2_reader_table_table_source_ready)) begin
            if (((litepciedma2_reader_table_loop_prog_n_storage == 1'd1) & litepciedma2_reader_table_table_source_first)) begin
                litepciedma2_reader_table_index <= 1'd0;
                ...
                if ((litepciedma2_reader_table_index == 16'd65535)) begin
...
always @(posedge to2853850009120_clk) begin
...
always @(posedge to2853850545216_clk) begin
...
always @(posedge to2853851326608_clk) begin
...
FDPE #(
	...
	.PRE(s7pciephy_msi_cdc_cd_rst),
	.Q(to2853850545216_rst)
);

endmodule

// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2023-01-11 12:33:30.
//------------------------------------------------------------------------------
