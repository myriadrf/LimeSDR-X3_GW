...
-- Architecture
-- ----------------------------------------------------------------------------
architecture arch of pll_top_test is
...
-- ----------------------------------------------------------------------------
  ...
  Port map( 
    ...
    resetn   => lms1_txpll_logic_reset_n,
...
-- ----------------------------------------------------------------------------
  ...
  Port map( 
    ...
    resetn   => lms1_rxpll_logic_reset_n,
...
-- ----------------------------------------------------------------------------
  ...
  Port map( 
    ...
    resetn   => lms2_txpll_logic_reset_n,
...
-- ----------------------------------------------------------------------------
  ...
  Port map( 
    ...
    resetn   => lms2_rxpll_logic_reset_n,
